    ...
    <body>
        ...
        <div class="content">
            <div class="container mt-5">
                ...
                <!-- Form to edit attribute -->
                <form action="edit-attribute" method="POST">
                    <input type="hidden" name="categoryID" value="${categoryID}" />

                    <div class="mb-3">
                        <label for="attributeID" class="form-label">Attribute ID</label>
                        <input type="text" class="form-control" id="attributeID" name="attributeID" value="${attribute.attributeID}" readonly>
                    </div>
                    ...
                    <c:if test="${not empty error}">
                        <div class="alert alert-danger">Attribute name already exists in this category!</div>
                    </c:if>

                    <button type="submit" class="btn btn-primary"><i class="fas fa-save"></i> Save Attribute</button>
                </form>
