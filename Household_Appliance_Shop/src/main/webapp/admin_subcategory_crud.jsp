    ...
    <body>
        <jsp:include page="admin_dashboard_header.jsp"></jsp:include>
            ...
            <div class="content">
                ...
                <!-- Add Category Button -->
                <a href="new-subcategory?categoryID=${categoryID}" class="btn btn-success mb-3"><i class="fas fa-plus"></i> Add New SubCategory</a>
                ...
                <table class="table table-bordered">
                    ...
                    <tbody>
                        <c:forEach var="subCategories" items="${requestScope.subCategories}">
                            <tr>
                        ...
                        <td>
                            <a href="newedit-subcategory?id=${subCategories.subCategoryID}" class="btn btn-primary btn-sm">
                                <i class="fas fa-edit"></i> Edit
                            </a>
                            <a href="delete-subcategory?id=${subCategories.subCategoryID}&categoryID=${categoryID}" class="btn btn-danger btn-sm"
